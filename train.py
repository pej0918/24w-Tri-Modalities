...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='data/msrvtt_category_train.pkl', type=str)
    parser.add_argument('--val_data_path', default='data/msrvtt_category_test.pkl', type=str)

...
from everything_at_once.logger import setup_logging
from everything_at_once.utils import write_yaml, read_config
import time
import inspect


class ConfigParser:
    def __init__(self, args, options='', timestamp=True, test=False, parse_from_string=None):
        ...
        # update neptune
        if not test and args.neptune:
            config['trainer']['neptune'] = True
